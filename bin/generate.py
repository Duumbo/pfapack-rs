...
def translate_base_type(cty):
    cty = cty.replace('floatcmplx', 'lapack_complex_float')
    cty = cty.replace('doublecmplx', 'lapack_complex_double')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sys', default='pfapack')
    arguments = parser.parse_args()
    path = os.path.join(arguments.sys, 'src', 'pfapack.rs')
